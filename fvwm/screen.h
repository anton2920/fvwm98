...
#define BLOCKSNUMBER 50
extern int active_has_shading;
extern int normal_has_shading;
...
typedef struct ScreenInfo
{
  ...
  /* these GCs have been added by Umberto Nicoletti
     to have shaded title bars as in Windoze98 */
  GC HiShades[BLOCKSNUMBER];
  GC LoShades[BLOCKSNUMBER];
